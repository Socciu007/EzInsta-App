...
import viewVideoLeft from '../../assets/icon/icon-videoViewLeft.svg';
import viewVideoIcon from '../../assets/icon/icon-videoViewNode.svg';
...
function viewVideoNode({ data: { label, onButtonClick, onDeleteNode }, isConnectable, id }) {
  ...
  return (
    <div className="updater-node">
      ...
      <div className="node">
        <img src={viewVideoLeft} alt="like comment Left" />
        <div className="content">
          <img src={viewVideoIcon} alt="like comment" />
